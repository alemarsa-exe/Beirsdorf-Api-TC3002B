                ...
                <div
                    ...
                    <div className="mr-auto place-self-center lg:col-span-7">
                        <h1 className="max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">
                            {" "}
                            A spam detector to power your productivity.
                        </h1>
                        <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                            This tool helps you to  determine if an email is spam. With its user-friendly interface,
                            it quickly analyzes your emails and provides clear, accurate results,
                            helping you keep your inbox safe.
                        </p>
